...
const Menu = () => {
  ...
  const [isPorfileDropdownOpen, setIsProfileDropdownOpen] = useState(false);

  const handleMenuClick = (index) => {
    setSelectMenu(index);
  };

  const handleProfileClcik = (index) => {
    setIsProfileDropdownOpen(!isPorfileDropdownOpen);
  };
  ...
  return (
    ...
    >
      <img src="media/images/logo.png" alt="" style={{ width: "50px" }}></img>
      <div className="menus">
        <ul>
          <li>
            <Link
        ...
        <hr />
        <div className="profile" onClick={handleProfileClcik}>
